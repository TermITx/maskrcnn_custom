...
class KangarooDataset(Dataset):
    ...
    def load_dataset(self, dataset_dir, is_train=True):
        ...
        self.add_class("dataset", 3, "partially-visible persons")
        self.add_class("dataset", 4, "ignore regions")
    ...
    def extract_boxes(self, filename, image_id):
        ...
        for box in lines[1:]:
            ...
            coors = [xmin, ymin, xmax, ymax, class_label]
            boxes.append(coors)

        # extract image dimensions
        from PIL import Image
        filepath = self.images_dir + str(self.image_info[image_id]["id"]) + ".jpg"
...
def train(model):
    ...
    dataset_train.load_dataset('C:/Users/Karlo/Desktop/diplomski/maskrcnn/Mask_RCNN/masks/train/', is_train=True)
    dataset_train.prepare()

    # Validation dataset
    dataset_val = KangarooDataset()
    dataset_val.load_dataset('C:/Users/Karlo/Desktop/diplomski/maskrcnn/Mask_RCNN/masks/train/', is_train=False)
    dataset_val.prepare()
